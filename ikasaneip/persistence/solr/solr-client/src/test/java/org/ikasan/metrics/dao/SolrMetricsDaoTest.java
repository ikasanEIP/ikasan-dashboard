...
public class SolrMetricsDaoTest extends SolrTestCaseJ4
{
    ...
    public void test_convert_entity_to_solr_input_document() throws IOException, JSONException {
        ...
        JSONAssert.assertEquals("{\"id\":24271,\"moduleName\":\"My Module\",\"flowName\":\"Trade Consumer Flow\"," +
            ...
            "\"beforeRelatedEventIdentifier\":null,\"afterEventIdentifier\":\"-1996324143\",\"afterRelatedEventIdentifier\":null," +
            "\"startTimeMillis\":1623325830491,\"endTimeMillis\":1623325830496,\"id\":561,\"metrics\":[],\"wiretapFlowEvent\"" +
            ":{\"identifier\":562,\"event\":\"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?><bdm><trade><trade-id>88634252</trade-id>" +
            "<asset><isin>XS2201078503</isin></asset><trade-details><nominal>895715</nominal><price>103.554</price><amount>7.7193923646E7<" +
            "/amount><currency>USD</currency><trade-date-time>2021-06-10T12:50:30</trade-date-time></trade-details><book>GBP_GOVT</book>" +
            "<party-details><counterparty>ACME Corporation</counterparty></party-details></trade></bdm>\",\"moduleName\":\"My Module\"," +
            "\"flowName\":\"Trade Consumer Flow\",\"componentName\":\"JMS Producer\",\"timestamp\":1623325830491,\"expiry\":1623325830491," +
            "\"eventId\":\"-1996324143\",\"relatedEventId\":null}},{\"componentName\":\"JMS Consumer\",\"beforeEventIdentifier\":" +
            "\"-1996324143\",\"beforeRelatedEventIdentifier\":null,\"afterEventIdentifier\":\"-1996324143\",\"afterRelatedEventIdentifier" +
            "\":null,\"startTimeMillis\":1623325830486,\"endTimeMillis\":1623325830487,\"id\":562,\"metrics\":[],\"wiretapFlowEvent\":" +
            "{\"identifier\":561,\"event\":\"ActiveMQTextMessage {commandId = 5, responseRequired = false, messageId = ID:" +
            "Michaels-MacBook-Pro.local-55556-1623243068313-7:24490:1:1:1, originalDestination = null, originalTransactionId = " +
            "null, producerId = ID:Michaels-MacBook-Pro.local-55556-1623243068313-7:24490:1:1, destination = queue://com.caixa.bank.murex.out," +
            " transactionId = null, expiration = 0, timestamp = 1623325830485, arrival = 0, brokerInTime = 1623325830486, brokerOutTime = " +
            "1623325830486, correlationId = null, replyTo = null, persistent = true, type = null, priority = 4, groupID = null, " +
            "groupSequence = 0, targetConsumerId = null, compressed = false, userID = null, content = org.apache.activemq.util." +
            "ByteSequence@5e5e1ee4, marshalledProperties = org.apache.activemq.util.ByteSequence@60f3cba8, dataStructure = null, " +
            "redeliveryCounter = 0, size = 0, properties = {IkasanEventLifeIdentifier=-1996324143}, readOnlyProperties = true, " +
            "readOnlyBody = true, droppable = false, jmsXGroupFirstForConsumer = false, text = <?xml version=\\\"1.0\\\" encoding=" +
            "\\\"UTF-8\\\" standalo...rade></mxml>}\",\"moduleName\":\"My Module\",\"flowName\":\"Trade Consumer Flow\",\"componentName\":" +
            "\"JMS Consumer\",\"timestamp\":1623325830486,\"expiry\":1623325830486,\"eventId\":\"-1996324143\",\"relatedEventId\":null}}]," +
            "\"harvested\":true,\"expiry\":1623930630497,\"errorUri\":null,\"harvestedDateTime\":1623325840029,\"flowInvocationEvents\":" +
            "[{\"componentName\":\"JMS Producer\",\"beforeEventIdentifier\":\"-1996324143\",\"beforeRelatedEventIdentifier\":null,\"" +
            "afterEventIdentifier\":\"-1996324143\",\"afterRelatedEventIdentifier\":null,\"startTimeMillis\":1623325830491,\"endTimeMillis\"" +
            ":1623325830496,\"id\":561,\"metrics\":[],\"wiretapFlowEvent\":{\"identifier\":562,\"event\":\"<?xml version=\\\"1.0\\\" " +
            "encoding=\\\"UTF-8\\\"?><bdm><trade><trade-id>88634252</trade-id><asset><isin>XS2201078503</isin></asset><trade-details>" +
            "<nominal>895715</nominal><price>103.554</price><amount>7.7193923646E7</amount><currency>USD</currency>" +
            "<trade-date-time>2021-06-10T12:50:30</trade-date-time></trade-details><book>GBP_GOVT</book><party-details>" +
            "<counterparty>ACME Corporation</counterparty></party-details></trade></bdm>\",\"moduleName\":\"My Module\",\"flowName\":" +
            "\"Trade Consumer Flow\",\"componentName\":\"JMS Producer\",\"timestamp\":1623325830491,\"expiry\":1623325830491,\"eventId\":" +
            "\"-1996324143\",\"relatedEventId\":null}},{\"componentName\":\"JMS Consumer\",\"beforeEventIdentifier\":\"-1996324143\"," +
            "\"beforeRelatedEventIdentifier\":null,\"afterEventIdentifier\":\"-1996324143\",\"afterRelatedEventIdentifier\":null," +
            "\"startTimeMillis\":1623325830486,\"endTimeMillis\":1623325830487,\"id\":562,\"metrics\":[],\"wiretapFlowEvent\":" +
            "{\"identifier\":561,\"event\":\"ActiveMQTextMessage {commandId = 5, responseRequired = false, messageId = ID:" +
            "Michaels-MacBook-Pro.local-55556-1623243068313-7:24490:1:1:1, originalDestination = null, originalTransactionId = null, " +
            "producerId = ID:Michaels-MacBook-Pro.local-55556-1623243068313-7:24490:1:1, destination = queue://com.caixa.bank.murex.out, " +
            "transactionId = null, expiration = 0, timestamp = 1623325830485, arrival = 0, brokerInTime = 1623325830486, brokerOutTime = " +
            "1623325830486, correlationId = null, replyTo = null, persistent = true, type = null, priority = 4, groupID = null, groupSequence = 0," +
            " targetConsumerId = null, compressed = false, userID = null, content = org.apache.activemq.util.ByteSequence@5e5e1ee4, marshalledProperties = " +
            "org.apache.activemq.util.ByteSequence@60f3cba8, dataStructure = null, redeliveryCounter = 0, size = 0, properties = " +
    ...
    public void test_get_results_within_timeframe_with_paging() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            long count = dao.count(10000000L, System.currentTimeMillis() + 10000000L);
            ...
            results = dao.getMetrics(10000000L
    ...
    public void test_get_count_within_timeframe() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            long results = dao.count(10000000L
                , System.currentTimeMillis() + 10000000L);
    ...
    public void test_get_count_by_module_name_within_timeframe() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            long results = dao.count("My Module", 10000000L
                , System.currentTimeMillis() + 10000000L);

            assertEquals(5, results);

            results = dao.count("Bad module name", 10000000L
                , System.currentTimeMillis() + 10000000L);
    ...
    public void test_get_results_by_module_within_timeframe_with_paging() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            results = dao.getMetrics("My Module",10000000L
                , System.currentTimeMillis() + 10000000L, 200, 200);
    ...
    public void test_get_large_by_module_name_within_timeframe_exceeds_query_limit() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            dao.getMetrics("My Module",10000000L
                , System.currentTimeMillis() + 10000000L, 0, 300);
        }
    }
    ...
    public void test_get_count_by_module_name_flow_name_within_timeframe() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            long results = dao.count("My Module", "Trade Consumer Flow",10000000L
                , System.currentTimeMillis() + 10000000L);

            assertEquals(5, results);

            results = dao.count("Bad module name", "Trade Consumer Flow",10000000L
                , System.currentTimeMillis() + 10000000L);
    ...
    public void test_get_results_by_module_flow_name_within_timeframe_with_paging() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            results = dao.getMetrics("My Module", "Trade Consumer Flow",10000000L
                , System.currentTimeMillis() + 10000000L, 200, 200);
    ...
    public void test_get_large_by_module_name_flow_name_within_timeframe_exceeds_query_limit() throws Exception {
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            dao.getMetrics("My Module", "Trade Consumer Flow",10000000L
                , System.currentTimeMillis() + 10000000L, 0, 300);
        }
    }
