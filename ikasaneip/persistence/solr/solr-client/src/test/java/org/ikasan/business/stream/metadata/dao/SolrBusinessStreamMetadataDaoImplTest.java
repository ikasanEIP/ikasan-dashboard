...
public class SolrBusinessStreamMetadataDaoImplTest extends SolrTestCaseJ4
{
    public static final String BUSINESS_STREAM_JSON = "/data/businessStream.json";

    private SolrBusinessStreamMetadataDaoImpl dao;
    ...
    private void init(EmbeddedSolrServer server) throws IOException, SolrServerException
    {
        ...
        dao = new SolrBusinessStreamMetadataDaoImpl();
