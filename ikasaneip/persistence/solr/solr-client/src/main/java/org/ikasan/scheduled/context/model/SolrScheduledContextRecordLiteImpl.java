...
public class SolrScheduledContextRecordLiteImpl implements ScheduledContextRecordLite {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        SolrScheduledContextRecordLiteImpl that = (SolrScheduledContextRecordLiteImpl) o;
    ...
    public String toString() {
        return new StringJoiner(", ", SolrScheduledContextRecordLiteImpl.class.getSimpleName() + "[", "]")
            .add("id='" + id + "'")
