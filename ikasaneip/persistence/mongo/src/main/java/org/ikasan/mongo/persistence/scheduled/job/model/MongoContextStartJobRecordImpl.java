...
public class MongoContextStartJobRecordImpl implements ContextStartJobRecord {
    ...
    public ContextStartJob getContextStartJob() {
        try {
            return OBJECT_MAPPER.readValue(contextStartJob, ContextStartJobImpl.class);
        } catch (JacksonException e) {
            throw new EntityConversionException("Could not convert string to entity: " + this.contextStartJob, e);
        }
    }
    ...
    public void setContextStartJob(ContextStartJob contextStartJob) {
        try {
            this.contextStartJob = OBJECT_MAPPER.writeValueAsString(contextStartJob);
        } catch (JacksonException e) {
            throw new EntityConversionException("Could not convert entity to string: " + contextStartJob, e);
        }
    }
