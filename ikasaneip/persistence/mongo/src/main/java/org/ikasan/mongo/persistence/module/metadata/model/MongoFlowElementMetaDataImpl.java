...
/**
 * MongoDB implementation of FlowElementMetaData.
 */
public class MongoFlowElementMetaDataImpl implements FlowElementMetaData {
    ...
    public String toString() {
        return "MongoFlowElementMetaDataImpl{" +
