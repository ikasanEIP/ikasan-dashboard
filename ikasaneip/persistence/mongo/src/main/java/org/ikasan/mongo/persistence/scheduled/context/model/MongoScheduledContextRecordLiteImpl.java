...
/**
 * Lightweight implementation of ScheduledContextRecordLite for MongoDB persistence.
 * Used for efficient listing and filtering without loading full context templates.
 */
public class MongoScheduledContextRecordLiteImpl implements ScheduledContextRecordLite {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        MongoScheduledContextRecordLiteImpl that = (MongoScheduledContextRecordLiteImpl) o;
    ...
    public String toString() {
        return new StringJoiner(", ", MongoScheduledContextRecordLiteImpl.class.getSimpleName() + "[", "]")
            .add("id='" + id + "'")
