...
public class MongoNotificationSendAuditImpl implements NotificationSendAudit {
    ...
    public MongoNotificationSendAuditImpl() {
    }

    public MongoNotificationSendAuditImpl(String jobName, String contextInstanceId, String contextName,
    ...
    public String toString() {
        return "MongoNotificationSendAuditImpl{" +
            "jobName='" + jobName + '\'' +
