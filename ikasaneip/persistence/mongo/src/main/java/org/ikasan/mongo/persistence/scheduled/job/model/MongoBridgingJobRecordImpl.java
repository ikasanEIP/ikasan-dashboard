...
public class MongoBridgingJobRecordImpl implements BridgingJobRecord {
    ...
    public BridgingJob getBridgingJob() {
        try {
            return OBJECT_MAPPER.readValue(bridgingJob, BridgingJobImpl.class);
        } catch (JacksonException e) {
            throw new EntityConversionException("Could not convert string to entity: " + this.bridgingJob, e);
        }
    }
    ...
    public void setBridgingJob(BridgingJob bridgingJob) {
        try {
            this.bridgingJob = OBJECT_MAPPER.writeValueAsString(bridgingJob);
        } catch (JacksonException e) {
            throw new EntityConversionException("Could not convert entity to string: " + bridgingJob, e);
        }
    }
