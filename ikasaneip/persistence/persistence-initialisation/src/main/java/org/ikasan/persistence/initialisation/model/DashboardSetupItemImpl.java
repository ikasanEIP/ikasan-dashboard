 ...
 */
public class DashboardSetupItemImpl implements DashboardSetupItem {
     ...
     */
    public DashboardSetupItemImpl(String name, String status, long executionTimestamp) {
        this.name = name;
        this.status = status;
