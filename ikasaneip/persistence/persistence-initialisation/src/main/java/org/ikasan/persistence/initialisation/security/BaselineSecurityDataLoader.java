package org.ikasan.persistence.initialisation.security;
...
import org.ikasan.persistence.initialisation.core.InitialDataJobConstants;
import org.ikasan.persistence.initialisation.model.IkasanPrincipalImpl;
import org.ikasan.persistence.initialisation.model.PolicyImpl;
import org.ikasan.persistence.initialisation.model.RoleImpl;
import org.ikasan.persistence.initialisation.model.UserImpl;
...
@Service
public class BaselineSecurityDataLoader implements DataJob {
    ...
    public String getJobName() {
        return InitialDataJobConstants.SOLR_BASELINE_SECURITY_DATA_JOB_NAME;
    }
    ...
    public void execute() throws DataJobException {
        ...
        try {
            ...
            Map<String, IkasanPrincipal> principalMap = new HashMap<>();
            for (PrincipalData principalData : principalDataList) {
                IkasanPrincipalImpl principal = new IkasanPrincipalImpl();
            ...
            for (UserData userData : userDataList) {
                ...
                if (userData.getPrincipalNames() != null) {
                    ...
                    for (String principalName : userData.getPrincipalNames()) {
                        IkasanPrincipal principal = principalMap.get(principalName);
                        if (principal != null) {
            ...
            throw new DataJobException("Failed to load baseline security data into Solr", e);
        }
    }
