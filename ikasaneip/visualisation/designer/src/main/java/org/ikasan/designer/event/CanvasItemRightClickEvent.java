...
public class CanvasItemRightClickEvent extends CanvasItemClickEvent {
     ...
     * @param figure
     */
    public CanvasItemRightClickEvent(DesignerPalletImageItem designerPalletImageItem, int clickLocationX,
