...
public class AgentDetailsWidget extends Div {

    Logger logger = LoggerFactory.getLogger(AgentDetailsWidget.class);
    ...
    public AgentDetailsWidget(ModuleMetaData agent, ScheduledProcessManagementService scheduledProcessManagementService, DateFormatter dateFormatter
...
//        this.textField.setWidth("300px");
        ...
        H4 modules = new H4("Agent Details");
