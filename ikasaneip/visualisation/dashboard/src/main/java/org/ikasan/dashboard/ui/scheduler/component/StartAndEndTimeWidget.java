...
public class StartAndEndTimeWidget extends Div {

    public StartAndEndTimeWidget() {
        Div div = new Div();
        div.addClassNames("card-counter");
        div.setHeight("380px");

        div.add(getStartAndEndExecutionTimeChart());

        this.add(div);
    }

    public Chart getStartAndEndExecutionTimeChart() {
        Chart chart = new Chart(ChartType.SCATTER);

        Configuration configuration = chart.getConfiguration();

        configuration.setTitle("Start and End Time Of Scheduled Jobs");
