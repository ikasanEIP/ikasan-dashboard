    ...
    public void recalculate() {
        ...
        if(ui != null && ui.isAttached()) {
            ui.access(() -> {
                ...
                this.runningDiv.setText((stateMap.containsKey(State.RUNNING_STATE) && stateMap.get(State.RUNNING_STATE) != null
                    ? stateMap.get(State.RUNNING_STATE).size() + "" : "0")
                ...
                this.stoppedDiv.setText((stateMap.containsKey(State.STOPPED_STATE) && stateMap.get(State.STOPPED_STATE) != null
                    ? stateMap.get(State.STOPPED_STATE).size() + "" : "0")
                ...
                this.errorDiv.setText((stateMap.containsKey(State.STOPPED_IN_ERROR_STATE) && stateMap.get(State.STOPPED_IN_ERROR_STATE) != null
                    ? stateMap.get(State.STOPPED_IN_ERROR_STATE).size() + "" : "0")
                ...
                this.recoveringDiv.setText((stateMap.containsKey(State.RECOVERING_STATE) && stateMap.get(State.RECOVERING_STATE) != null
                    ? stateMap.get(State.RECOVERING_STATE).size() + "" : "0")
                ...
                this.pausedDiv.setText((stateMap.containsKey(State.PAUSED_STATE) && stateMap.get(State.PAUSED_STATE) != null
                    ? stateMap.get(State.PAUSED_STATE).size() + "" : "0")
                ...
                this.unknownDiv.setText((stateMap.containsKey(State.UNKNOWN_STATE) && stateMap.get(State.UNKNOWN_STATE) != null
                    ? stateMap.get(State.UNKNOWN_STATE).size() + "" : "0")
