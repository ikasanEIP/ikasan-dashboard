...
public class SearchFilteringGridTest extends UITest {
    ...
    public void test_filtered_data_provider_not_null_after_search() throws IOException {
        ...
        SearchFilteringGrid searchFilteringGrid = _get(SearchFilteringGrid.class);
        Assertions.assertNotNull(searchFilteringGrid);

        _click(_get(Icon.class, spec -> spec.withId("searchFormSearchButton")));

        Assert.assertNotNull(ReflectionTestUtils.getField(searchFilteringGrid, "filteredDataProvider"));
    }
    ...
    public void test_filtered_data_provider_null_before_search() throws IOException {
        ...
        Assert.assertNull(ReflectionTestUtils.getField(searchFilteringGrid, "filteredDataProvider"));
    ...
    public void test_search_no_filter_admin_user_search_no_event_types() {
        ...
        Assert.assertEquals(0, searchFilteringGrid.getResultSize());
    }
    ...
    public void test_search_with_sort_order() {
        ...
        GridKt.sort(searchFilteringGrid, new QuerySortOrder("moduleName", SortDirection.ASCENDING));

        _click(_get(Icon.class, spec -> spec.withId("searchFormSearchButton")));
        _click(_get(Icon.class, spec -> spec.withId("searchFormSearchButton")));

        Assert.assertEquals(10, searchFilteringGrid.getResultSize());
    }
