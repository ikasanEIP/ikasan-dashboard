#!/bin/bash
# Ikasan SolrCloud Environment - Multi-Host Node 1
#
...
ZK_CLIENT_PORT="${NODE1_ZK_CLIENT_PORT}"
ZK_PEER_PORT="${NODE1_ZK_PEER_PORT}"
ZK_ELECTION_PORT="${NODE1_ZK_ELECTION_PORT}"
ZK_ADMIN_PORT="${NODE1_ZK_ADMIN_PORT}"
...
NODE1_BINDING="0.0.0.0"
NODE2_BINDING="${NODE2_HOST}"
NODE3_BINDING="${NODE3_HOST}"
...
show_config() {
    echo "========================================"
    echo "Ikasan SolrCloud - Multi-Host Node 1"
    echo "========================================"
    echo ""
