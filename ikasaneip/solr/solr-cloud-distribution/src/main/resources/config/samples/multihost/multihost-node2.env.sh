#!/bin/bash
# Ikasan SolrCloud Environment - Multi-Host Node 2
#
...
ZK_CLIENT_PORT="${NODE2_ZK_CLIENT_PORT}"
ZK_PEER_PORT="${NODE2_ZK_PEER_PORT}"
ZK_ELECTION_PORT="${NODE2_ZK_ELECTION_PORT}"
ZK_ADMIN_PORT="${NODE2_ZK_ADMIN_PORT}"
...
show_config() {
    echo "========================================"
    echo "Ikasan SolrCloud - Multi-Host Node 2"
    echo "========================================"
    echo ""
