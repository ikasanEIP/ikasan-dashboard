...
public class SolrGlobalEventJobDaoImplTest extends SolrTestCaseJ4 {
    ...
    private void init(EmbeddedSolrServer server) throws IOException, SolrServerException
    {
        ...
        dao = new SolrGlobalEventJobDaoImpl();
    ...
    public void test_save_and_find_success() throws Exception {
        ...
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            GlobalEventJobRecord found = this.dao.findById("globalEventJob_idagentName0_jobName0_contextId");

            Assert.assertEquals("globalEventJob_idagentName0_jobName0_contextId", found.getId());
