...
import org.ikasan.scheduled.model.context.ScheduledContextInstanceRecordImpl;
...
public class SolrScheduledContextInstanceDaoTest extends SolrTestCaseJ4 {
    ...
    public void test_save_and_find_success() throws Exception {
        ...
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            ScheduledContextInstanceRecordImpl scheduledContextRecord = new ScheduledContextInstanceRecordImpl("id"
    ...
    public void test_status_update_success() throws Exception {
        ...
        try (EmbeddedSolrServer server = new EmbeddedSolrServer(config, "ikasan"))
        {
            ...
            ScheduledContextInstanceRecordImpl scheduledContextInstanceRecord = new ScheduledContextInstanceRecordImpl("id"
                , "contextName", "contextInstance", 1000000L);
