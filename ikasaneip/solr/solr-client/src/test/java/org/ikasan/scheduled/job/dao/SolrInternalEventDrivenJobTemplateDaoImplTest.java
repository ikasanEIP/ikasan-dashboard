...
public class SolrInternalEventDrivenJobTemplateDaoImplTest extends SolrTestCaseJ4 {

    private SolrInternalEventDrivenJobTemplateDaoImpl dao;
    ...
    private void init(EmbeddedSolrServer server) throws IOException, SolrServerException
    {
        ...
        dao = new SolrInternalEventDrivenJobTemplateDaoImpl();
