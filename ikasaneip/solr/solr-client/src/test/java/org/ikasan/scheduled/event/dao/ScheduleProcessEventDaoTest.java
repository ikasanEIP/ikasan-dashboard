...
import org.ikasan.scheduled.event.model.Outcome;
...
public class ScheduleProcessEventDaoTest extends SolrTestCaseJ4 {
    ...
    public void test_convert_entity_to_solr_input_document() throws JSONException {
        ...
        JSONAssert.assertEquals("{\"agentName\":\"agentName\",\"agentHostname\":null,\"jobName\":" +
                "\"jobName\",\"jobGroup\":\"jobGroup\",\"jobDescription\":\"jobDescription\",\"commandLine\":\"" +
                "commandLine\",\"resultOutput\":\"output\",\"resultError\":\"error\",\"pid\":1234,\"user\":\"user" +
                "\",\"fireTime\":1000,\"nextFireTime\":1000,\"successful\":true,\"completionTime\":1000,\"returnCode" +
                "\":0,\"outcome\":\"EXECUTION_INVOKED\",\"dryRunParameters\":null,\"dryRun\":false,\"jobStarting\":false}\""
