...
/**
 * Unit test for ScheduledConcurrentObjectMapperFactory focusing on:
 ...
 */
public class ScheduledConcurrentObjectMapperFactoryTest {
    ...
    public void test_newInstance_creates_objectMapper() {
        ObjectMapper objectMapper = ScheduledConcurrentObjectMapperFactory.newInstance();
    ...
    public void test_and_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("And should be deserialized as SolrAndImpl", and instanceof SolrAndImpl);
    }
    ...
    public void test_or_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("Or should be deserialized as SolrOrImpl", or instanceof SolrOrImpl);
    }
    ...
    public void test_not_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("Not should be deserialized as SolrNotImpl", not instanceof SolrNotImpl);
    }
    ...
    public void test_contextTemplate_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextTemplate should be deserialized as SolrContextTemplateImpl",
                   contextTemplate instanceof SolrContextTemplateImpl);
    }

    /**
     * Test Context abstract type mapping
     */
    @Test
    public void test_context_abstractTypeMapping() throws JsonProcessingException {
        ObjectMapper objectMapper = ScheduledConcurrentObjectMapperFactory.newInstance();

        String json = "{\"name\":\"test\"}";
        Context context = objectMapper.readValue(json, Context.class);

        assertTrue("Context should be deserialized as SolrContextImpl",
                   context instanceof SolrContextImpl);
    }
    ...
    public void test_contextParameter_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextParameter should be deserialized as SolrContextParameterImpl",
                   contextParameter instanceof SolrContextParameterImpl);
    }
    ...
    public void test_schedulerJob_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("SchedulerJob should be deserialized as SolrSchedulerJobImpl",
                   schedulerJob instanceof SolrSchedulerJobImpl);
    }
    ...
    public void test_schedulerJobLockParticipant_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("SchedulerJobLockParticipant should be deserialized as SolrSchedulerJobLockParticipantImpl",
                   participant instanceof SolrSchedulerJobLockParticipantImpl);
    }
    ...
    public void test_jobDependency_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("JobDependency should be deserialized as SolrJobDependencyImpl",
                   jobDependency instanceof SolrJobDependencyImpl);
    }
    ...
    public void test_contextDependency_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextDependency should be deserialized as SolrContextDependencyImpl",
                   contextDependency instanceof SolrContextDependencyImpl);
    }
    ...
    public void test_logicalGrouping_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("LogicalGrouping should be deserialized as SolrLogicalGroupingImpl",
                   logicalGrouping instanceof SolrLogicalGroupingImpl);
    }
    ...
    public void test_contextInstance_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextInstance should be deserialized as SolrContextInstanceImpl",
                   contextInstance instanceof SolrContextInstanceImpl);
    }
    ...
    public void test_schedulerJobInstance_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("SchedulerJobInstance should be deserialized as SolrSchedulerJobInstanceImpl",
                   jobInstance instanceof SolrSchedulerJobInstanceImpl);
    }
    ...
    public void test_contextParameterInstance_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextParameterInstance should be deserialized as SolrContextParameterInstanceImpl",
                   paramInstance instanceof SolrContextParameterInstanceImpl);
    }
    ...
    public void test_jobLock_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("JobLock should be deserialized as SolrJobLockImpl",
                   jobLock instanceof SolrJobLockImpl);
    }
    ...
    public void test_jobLockInstance_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("JobLockInstance should be deserialized as SolrJobLockInstanceImpl",
                   jobLockInstance instanceof SolrJobLockInstanceImpl);
    }
    ...
    public void test_scheduledProcessEvent_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ScheduledProcessEvent should be deserialized as SolrContextualisedScheduledProcessEventImpl",
                   event instanceof SolrContextualisedScheduledProcessEventImpl);
    }
    ...
    public void test_contextualisedScheduledProcessEvent_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextualisedScheduledProcessEvent should be deserialized as SolrContextualisedScheduledProcessEventImpl",
                   event instanceof SolrContextualisedScheduledProcessEventImpl);
    }
    ...
    public void test_contextualisedSchedulerJobInitiationEvent_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextualisedSchedulerJobInitiationEvent should be deserialized as SolrContextualisedSchedulerJobInitiationEventImpl",
                   event instanceof SolrContextualisedSchedulerJobInitiationEventImpl);
    }
    ...
    public void test_schedulerJobInitiationEvent_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("SchedulerJobInitiationEvent should be deserialized as SolrSchedulerJobInitiationEventImpl",
                   event instanceof SolrSchedulerJobInitiationEventImpl);
    }
    ...
    public void test_internalEventDrivenJob_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("InternalEventDrivenJob should be deserialized as SolrInternalEventDrivenJobImpl",
                   job instanceof SolrInternalEventDrivenJobImpl);
    }
    ...
    public void test_internalEventDrivenJobInstance_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("InternalEventDrivenJobInstance should be deserialized as SolrInternalEventDrivenJobInstanceImpl",
                   instance instanceof SolrInternalEventDrivenJobInstanceImpl);
    }

    /**
     * Test FileEventDrivenJobInstance abstract type mapping
     */
    @Test
    public void test_fileEventDrivenJobInstance_abstractTypeMapping() throws JsonProcessingException {
        ObjectMapper objectMapper = ScheduledConcurrentObjectMapperFactory.newInstance();

        String json = "{\"id\":\"test-id\"}";
        FileEventDrivenJobInstance instance = objectMapper.readValue(json, FileEventDrivenJobInstance.class);

        assertTrue("FileEventDrivenJobInstance should be deserialized as SolrFileEventDrivenJobInstanceImpl",
                   instance instanceof SolrFileEventDrivenJobInstanceImpl);
    }

    /**
     * Test QuartzScheduleDrivenJobInstance abstract type mapping
     */
    @Test
    public void test_quartzScheduleDrivenJobInstance_abstractTypeMapping() throws JsonProcessingException {
        ObjectMapper objectMapper = ScheduledConcurrentObjectMapperFactory.newInstance();

        String json = "{\"id\":\"test-id\"}";
        QuartzScheduleDrivenJobInstance instance = objectMapper.readValue(json, QuartzScheduleDrivenJobInstance.class);

        assertTrue("QuartzScheduleDrivenJobInstance should be deserialized as SolrQuartzScheduleDrivenJobInstanceImpl",
                   instance instanceof SolrQuartzScheduleDrivenJobInstanceImpl);
    }
    ...
    public void test_jobLockHolder_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("JobLockHolder should be deserialized as SolrJobLockHolderImpl",
                   holder instanceof SolrJobLockHolderImpl);
    }
    ...
    public void test_contextProfile_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextProfile should be deserialized as SolrContextProfileImpl",
                   profile instanceof SolrContextProfileImpl);
    }
    ...
    public void test_contextProfileRecord_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ContextProfileRecord should be deserialized as SolrContextProfileRecordImpl",
                   record instanceof SolrContextProfileRecordImpl);
    }
    ...
    public void test_replacementPair_abstractTypeMapping() throws JsonProcessingException {
        ...
        assertTrue("ReplacementPair should be deserialized as SolrReplacementPairImpl",
                   pair instanceof SolrReplacementPairImpl);
    }
