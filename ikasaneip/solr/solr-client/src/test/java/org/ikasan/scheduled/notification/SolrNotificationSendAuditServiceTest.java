...
public class SolrNotificationSendAuditServiceTest extends SolrTestCaseJ4 {

    private SolrNotificationSendAuditDaoImpl dao;
    private SolrNotificationSendAuditServiceImpl service;
    ...
    private void init(EmbeddedSolrServer server) throws IOException, SolrServerException
    {
        ...
        service = new SolrNotificationSendAuditServiceImpl(dao);
    }
