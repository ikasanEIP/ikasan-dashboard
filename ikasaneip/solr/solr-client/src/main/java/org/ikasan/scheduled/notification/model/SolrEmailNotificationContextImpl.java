...
/**
 * Represent the email notification for a given Context / Job Plan
 * Will give an overall representation of what notification to send
 */
public class SolrEmailNotificationContextImpl implements EmailNotificationContext {

    private String contextName;

    // List of monitor types we will be sending notification for
