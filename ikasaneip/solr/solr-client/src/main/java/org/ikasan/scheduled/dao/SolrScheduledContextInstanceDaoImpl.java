...
public class SolrScheduledContextInstanceDaoImpl extends SolrDaoBase<ScheduledContextInstanceRecord> implements ScheduledContextInstanceDao {
    ...
    public ScheduledContextInstanceRecord findById(String id) {
        ...
        List<ScheduledContextInstanceRecordImpl> beans = this.findByQuery(query);
     ...
     * @param query
     */
    private List<ScheduledContextInstanceRecordImpl> findByQuery(SolrQuery query) {
        ...
        try {
            ...
            return rsp.getBeans(ScheduledContextInstanceRecordImpl.class);
        }
        catch (Exception e)
        {
