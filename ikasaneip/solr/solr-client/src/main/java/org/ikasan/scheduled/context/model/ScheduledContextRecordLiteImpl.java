...
public class ScheduledContextRecordLiteImpl implements ScheduledContextRecordLite {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        ScheduledContextRecordLiteImpl that = (ScheduledContextRecordLiteImpl) o;
    ...
    public String toString() {
        return new StringJoiner(", ", ScheduledContextRecordLiteImpl.class.getSimpleName() + "[", "]")
            .add("id='" + id + "'")
