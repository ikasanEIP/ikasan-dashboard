...
public class InternalEventDrivenJobRecordServiceImpl implements InternalEventDrivenJobService {

    private InternalEventDrivenJobDao internalEventDrivenJobRecordDao;

    public InternalEventDrivenJobRecordServiceImpl(InternalEventDrivenJobDao internalEventDrivenJobRecordDao) {
