...
public class FileEventDrivenJobRecordImpl implements FileEventDrivenJobRecord {
    ...
    public FileEventDrivenJob getFileEventDrivenJob() {
        return objectMapper.readValue(fileEventDrivenJob, FileEventDrivenJobImpl.class);
    }
