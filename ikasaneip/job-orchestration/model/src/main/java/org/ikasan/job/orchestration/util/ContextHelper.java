...
public class ContextHelper {
    ...
    public static void _traceJobThroughContextTemplate(LinkedList<List<SchedulerJob>> results, ContextTemplate context, String jobName, String childContextName) {
