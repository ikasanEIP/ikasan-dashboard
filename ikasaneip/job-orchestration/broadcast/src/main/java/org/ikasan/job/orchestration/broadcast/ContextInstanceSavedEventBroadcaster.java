...
public class ContextInstanceSavedEventBroadcaster {
    private static final Logger LOGGER = LoggerFactory.getLogger(ContextInstanceSavedEventBroadcaster.class);

    private final ExecutorService executor = Executors.newSingleThreadExecutor(new BroadcasterThreadFactory("ContextInstanceSavedEventBroadcaster"));

    private final WeakHashMap<ContextInstanceSavedEventLocalBroadcastListener, Object> localListeners =
        new WeakHashMap<>();
    private ContextInstanceSavedEventRemoteBroadcastListener remoteListener;

    public static volatile ContextInstanceSavedEventBroadcaster INSTANCE = new ContextInstanceSavedEventBroadcaster();

    /**
     * Private constructor for the ContextInstanceSavedEventBroadcaster class.
     *
     ...
     */
    private ContextInstanceSavedEventBroadcaster() {}

    /**
     * Retrieves the singleton instance of the {@code ContextInstanceSavedEventBroadcaster}.
     * This method ensures that only one instance of the class exists, in compliance
     * with the singleton design pattern.
     *
     * @return the singleton instance of {@code ContextInstanceSavedEventBroadcaster}
     */
    public static ContextInstanceSavedEventBroadcaster instance() {
        return INSTANCE;
    }
     ...
     */
    public synchronized void register(ContextInstanceSavedEventLocalBroadcastListener listener) {
     ...
     */
    public synchronized void unregister(ContextInstanceSavedEventLocalBroadcastListener listener) {
     ...
     */
    public synchronized void setRemoteListener(ContextInstanceSavedEventRemoteBroadcastListener listener) {
    ...
    /**
     * Resets the singleton instance of the {@code ContextInstanceSavedEventBroadcaster}.
     *
    ...
    private synchronized void reset() {
        ...
        INSTANCE = new ContextInstanceSavedEventBroadcaster();
    }
}
