...
public class NewSchedulerJobEventBroadcasterTest {
    ...
    public void testLocalBroadcast_onStaleReferenceAfterReset_throwsRejectedExecutionException() throws Exception {
        NewSchedulerJobEventBroadcaster staleReference = NewSchedulerJobEventBroadcaster.instance();
        ...
        Assert.assertThrows(RejectedExecutionException.class, () -> staleReference.localBroadcast(schedulerJob));
    }
}
