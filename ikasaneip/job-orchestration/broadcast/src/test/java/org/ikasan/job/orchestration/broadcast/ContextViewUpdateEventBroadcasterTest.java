...
public class ContextViewUpdateEventBroadcasterTest {
    ...
    public void testLocalBroadcast_onStaleReferenceAfterReset_throwsRejectedExecutionException() throws Exception {
        ContextViewUpdateEventBroadcaster staleReference = ContextViewUpdateEventBroadcaster.instance();
        ...
        Assert.assertThrows(RejectedExecutionException.class, () -> staleReference.localBroadcast(testMessage));
    }
}
