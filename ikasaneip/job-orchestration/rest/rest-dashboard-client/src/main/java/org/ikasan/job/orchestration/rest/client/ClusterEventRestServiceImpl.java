...
public class ClusterEventRestServiceImpl extends ClusterNodeRestServiceImpl implements ClusterEventService {
    ...
    public ClusterEventRestServiceImpl(String baseUrl, Environment environment,
