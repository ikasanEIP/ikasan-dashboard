...
@WebAppConfiguration
@EnableWebMvc
class ClusterEventControllerTest {
    ...
    @Test
    void test_handle_context_instance_state_change_success() throws Exception {
    ...
    @Test
    void test_handle_scheduler_job_state_change_success() throws Exception {
    ...
    @Test
    void test_handle_context_instance_saved_success() throws Exception {
    ...
    @Test
    void test_handle_context_instance_dlq_success() throws Exception {
        String json = objectMapper.writeValueAsString(new ContextInstanceImpl());
    ...
    @Test
    void test_handle_context_template_saved_success() throws Exception {
    ...
    @Test
    void test_handle_context_template_enable_disable_success() throws Exception {
        String json = objectMapper.writeValueAsString(new ContextTemplateImpl());
    ...
    @Test
    void test_handle_context_view_update_success() throws Exception {
    ...
    @Test
    void test_handle_new_scheduler_job_success() throws Exception {
    ...
    @Test
    void test_handle_job_lock_cache_success() throws Exception {
    ...
    @Test
    void test_bad_content_returns_bad_request() throws Exception {
        MvcResult result = mvc.perform(MockMvcRequestBuilders
            .post("/rest/clusterEvents/context-instance-state-change")
            .contentType(MediaType.APPLICATION_JSON_VALUE)
