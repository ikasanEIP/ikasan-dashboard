...
import org.ikasan.scheduled.SearchResultsImpl;
import org.ikasan.scheduled.context.model.HibernateScheduledContextRecordLiteImpl;
...
public class HibernateScheduledContextServiceImpl implements ScheduledContextService {
    ...
    private ScheduledContextRecord createScheduledContextRecord(String contextName, ContextTemplate contextTemplate) {
        // This would need to be implemented based on the concrete HibernateScheduledContextRecordImpl class
        // For now, throwing an UnsupportedOperationException as this requires the concrete implementation
        throw new UnsupportedOperationException(
            "cloneContext is not yet implemented - requires concrete ScheduledContextRecord implementation");
    }
    ...
    private ContextTemplate cloneContextTemplate(ContextTemplate sourceTemplate, String clonedContextName) {
        // This would need to be implemented based on the concrete ContextTemplate implementation
        // For now, throwing an UnsupportedOperationException as this requires the concrete implementation
        throw new UnsupportedOperationException(
            "cloneContext is not yet implemented - requires concrete ContextTemplate implementation");
    }
}
