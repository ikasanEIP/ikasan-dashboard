 ...
 */
@RequestMapping("/rest/dashboard/bigQueue")
@RestController
public class BigQueueDashboardController {

    private static final Logger LOG = LoggerFactory.getLogger(BigQueueDashboardController.class);
