...
@SpringBootTest(classes = {BigQueueDashboardController.class})
@EnableWebMvc
public class BigQueueDashboardControllerTest {
    ...
    public void size_web_admin() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/size/queueName")
    ...
    public void peek_web_admin() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/peek/queueName")
            .accept(MediaType.APPLICATION_JSON);

        MvcResult result = mockMvc.perform(requestBuilder).andReturn();

        assertEquals(200, result.getResponse().getStatus());
        assertEquals("{\"createdTime\":1657509967,\"message\":\"some message\",\"messageId\":\"uuidAsMessageId\",\"messageProperties\":null}",
    ...
    public void messages_web_admin() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/messages/queueName")
            .accept(MediaType.APPLICATION_JSON);

        MvcResult result = mockMvc.perform(requestBuilder).andReturn();

        assertEquals(200, result.getResponse().getStatus());
        assertEquals("[{\"createdTime\":1657509967,\"message\":\"some message 1\",\"messageId\":\"uuidAsMessageId1\",\"messageProperties\":null},{\"createdTime\":1657509960,\"message\":\"some message 2\",\"messageId\":\"uuidAsMessageId1\",\"messageProperties\":null}]",
            result.getResponse().getContentAsString());
    ...
    public void delete_admin() throws Exception {
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/rest/dashboard/bigQueue/delete/queueName/messageId")
            .accept(MediaType.APPLICATION_JSON)
    ...
    public void get_queues_admin() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/")
            .accept(MediaType.APPLICATION_JSON)
            .contentType(MediaType.APPLICATION_JSON);
    ...
    public void size_all_web_admin() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/size")
            .accept(MediaType.APPLICATION_JSON);
    ...
    public void size_all_web_admin_dont_include_zeros() throws Exception {
        ...
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/rest/dashboard/bigQueue/size?includeZeros=false")
            .accept(MediaType.APPLICATION_JSON);
