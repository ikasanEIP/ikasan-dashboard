...
public class ModuleControlRestServiceImplTest
{
    ...
    public void updateFlowStatus()
    {
        ...
        stubFor(put(urlEqualTo(ModuleControlRestServiceImpl.CHANGE_FLOW_STATE_URL))
            .withHeader(HttpHeaders.CONTENT_TYPE, equalTo(MediaType.APPLICATION_JSON.toString()))
            .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_JSON.toString()))
            .withRequestBody(containing("{\"action\":\"start\",\"flowName\":\"flow Test\",\"moduleName\":\"test Module Name\",\"username\":\"testUser\"}"))
            .willReturn(aResponse()
                .withHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON.toString())
                .withStatus(200)
            ));
    ...
    public void updateFlowStatus_returns400()
    {
        ...
        stubFor(put(urlEqualTo(ModuleControlRestServiceImpl.CHANGE_FLOW_STATE_URL))
            .withHeader(HttpHeaders.CONTENT_TYPE, equalTo(MediaType.APPLICATION_JSON.toString()))
            .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_JSON.toString()))
            .withRequestBody(containing("{\"action\":\"T\",\"flowName\":\"flow Test\",\"moduleName\":\"test Module Name\",\"username\":\"testUser\"}"))
            .willReturn(aResponse()
                .withHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON.toString())
                .withStatus(400)
            ));
    ...
    public void changeFlowStartup()
    {
        ...
        stubFor(put(urlEqualTo(ModuleControlRestServiceImpl.CHANGE_FLOW_STARTUP_MODE_URL))
                    .withHeader(HttpHeaders.CONTENT_TYPE, equalTo(MediaType.APPLICATION_JSON.toString()))
                    .withHeader(HttpHeaders.ACCEPT, equalTo(MediaType.APPLICATION_JSON.toString()))
                    .withRequestBody(containing("{\"comment\":null,\"flowName\":\"flow Test\",\"moduleName\":\"test Module Name\",\"startupType\":\"automatic\",\"username\":\"testUser\"}"))
                    .willReturn(aResponse()
                                    .withHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON.toString())
                                    .withStatus(200)
                               ));
